        ...
        <div class="main">
            ...
            <main class="content px-3 py-4">
                <div class="container-fluid">
                    <form action="{{ route('produks.update', ['produk' => $produk->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row justify-content-center">
                            <div class="p-5 bg-light rounded-3 col-xl-6 shadow-sm" style="width: 1200px">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input
                                            ...
                                            value="{{ $errors->any() ? old('namaProduk') : $produk->namaproduk }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control @error('kodeProduk')is-invalid @enderror"
                                            ...
                                            value="{{ $errors->any() ? old('kodeProduk') : $produk->kodeproduk }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <img src="{{asset('storage/gambar-produk/'.$produk->gambar)}}" alt="gambar-produk" style="width: 50px">
                                        <input class="form-control @error('gambar')is-invalid @enderror"
                                            type="file" name="gambar" id="gambar"
                                            value="{{ $errors->any() ? old('gambar') : $produk->gambar }}">
                                        @error('gambar')
                                            <div class="text-danger"><small>{{ $message }}</small></div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input class="form-control @error('unit') is-invalid @enderror" type="text"
                                            name="unit" id="unit"
                                            value="{{ $errors->any() ? old('unit') : $produk->unit }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 d-grid">
                                        <button type="submit" class="btn btn-info btn-lg mt-3" style="color:#fff">
                                            <i class="bi bi-check2-square"></i> Edit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
